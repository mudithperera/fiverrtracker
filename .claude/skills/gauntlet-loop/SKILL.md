...
Source: [robonuggets/gauntlet-loop](https://github.com/robonuggets/gauntlet-loop) by Jay E (RoboNuggets), CC BY 4.0. Technique by [Matt Shumer](https://github.com/mshumer).
